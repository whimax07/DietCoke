...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
OG Code from neozhaoliang pywonderland on github
"""
import numpy as np
import cairocffi as cairo


ITERATIONS = 18  # total number of iterations
ROOT_COLOR = np.array([0.0, 0.0, 0.0])  # root branch color
LEAF_COLOR = np.array([1.0, 1.0, 0.2])  # leaf color
TRUNK_LEN = 600  # initial length of the trunk
TRUNK_RAD = 6.0  # initial radius of the trunk
...
RATIO = 0.75  # contraction factor between successive trunks
